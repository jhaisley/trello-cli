...
def test_ai_label_command(mock_get_db, mock_genai_model, mock_get_trello_client, mock_trello_and_gemini):
    mock_trello_client, mock_gemini_model, mock_card_unlabeled, mock_label_obj = mock_trello_and_gemini
    ...
    mock_db_session.query.return_value.filter.return_value.first.return_value = mock_gemini_key
